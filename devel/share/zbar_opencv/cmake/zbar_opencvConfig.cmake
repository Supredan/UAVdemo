...
if("TRUE" STREQUAL "TRUE")
  set(zbar_opencv_SOURCE_PREFIX /home/pi/UAV_demo/src/zbar_opencv)
  set(zbar_opencv_DEVEL_PREFIX /home/pi/UAV_demo/devel)
  ...
  set(zbar_opencv_INSTALL_PREFIX /home/pi/UAV_demo/install)
...
if(NOT "/home/pi/UAV_demo/src/zbar_opencv/include " STREQUAL " ")
  set(zbar_opencv_INCLUDE_DIRS "")
  set(_include_dirs "/home/pi/UAV_demo/src/zbar_opencv/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'zbar_opencv' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/UAV_demo/src/zbar_opencv/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT zbar_opencv_NUM_DUMMY_TARGETS)
      set(zbar_opencv_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::zbar_opencv::wrapped-linker-option${zbar_opencv_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR zbar_opencv_NUM_DUMMY_TARGETS "${zbar_opencv_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::zbar_opencv::wrapped-linker-option${zbar_opencv_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND zbar_opencv_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/pi/UAV_demo/devel/lib;/opt/ros/melodic/lib)
...
set(depends "cv_bridge;image_transport;roscpp;sensor_msgs;std_msgs;crazyflie_cpp")
